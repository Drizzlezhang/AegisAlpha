...
class TestBrokerPosition:
    ...
    def test_full_option_position(self) -> None:
        pos = BrokerPosition(
            account="futu", ticker="QQQ", pos_type="option", quantity=10, avg_cost=5.0,
            current_price=6.5, strike=400.0, expiry="2025-12-19", option_type="call",
            delta=0.65, gamma=0.02, theta=-0.05, vega=0.15, iv=0.22,
            delta_dollars=26000.0, unrealized_pnl=1500.0,
            entry_mode="active_right", grade="active",
        )
